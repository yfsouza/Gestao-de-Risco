    ...
    <div>
      ...
      <div className="card">
        <div className="screen-header">
          ...
          <div className="form-actions">
            <button className="btn-outline" type="button" onClick={()=>setForm({ probabilidade: 'Média', impacto: 'Médio', status: 'Aberto', matriz: 'Default' })}><i className="fa-solid fa-eraser"></i> Limpar formulário</button>
          </div>
        </div>
